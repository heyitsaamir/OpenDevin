...
* `message` - make a plan, set a goal, or record your thoughts. Arguments:
  ...
  * `wait_for_response` - set to true if you need clarification from the user before proceeding. Use sparingly and only if it is difficult to make progress without further clarification. If this is set to true, the value of `content` should be a short clear question for the user.
